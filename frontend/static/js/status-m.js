...
Status =
{
	...
	init: function()
	{
		...
		rowArray.sort(function (a, b) {
			var ka = a.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "key").value;
			var kb = b.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "key").value;
