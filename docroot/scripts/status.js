...
Status = {
	...
	sortTable: function(table, column) {
		...
		rowArray.sort(function (a, b) {
			var ka = a.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "keys").value.split('|')[column];
			var kb = b.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "keys").value.split('|')[column];
