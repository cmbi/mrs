...
RUN apt-get install -y git g++ libboost-all-dev libbz2-dev libz-dev doxygen xsltproc docbook docbook-xsl docbook-xml autoconf automake autotools-dev liblog4cpp5-dev libperl-dev
RUN mkdir -p /deps
