...
function orderBy(by)
{
	...
	rowArray.sort(function (a, b) {
		...
		if (by == 'relevance')
		{
			var scA = a.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "score");
			var scB = b.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "score");
		...
		if (d == 0)
		{
			var dbA = a.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "db");
			var dbB = b.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "db");
			...
			{
				var nrA = a.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "hitNr");
				var nrB = b.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "hitNr");
...
function nrOfHitsToShow(nr, max)
{
	...
	for (var d = 1; d < rows.length; ++d)
	{
		...
		var hitNr = row.attributes.getNamedItemNS("http://mrs.cmbi.umcn.nl/mrs-web/nl/my-ns", "hitNr");
